...
<select   name="isHaving" id="isHaving" class="bg" style="width:50"  name=ifshare onChange=shareOnChange(this)>
  ...
  <input style="font-size:12px; color:black; height=22;width=55"  id="BT_Add" type="button" value="详细" name="BT_Add" onClick="openWindowWithName('repairFile.jsp?ZhengRi1=1&devId=c51da3d47c814b488d4a4206c7a1703f',800,450,'ECC');" />
  </span>
</TD>
</TR>
