						...
						style="BORDER-RIGHT:gray 1px solid; BORDER-TOP:gray 1px solid; BORDER-LEFT:gray 1px solid; WIDTH:100%; WORD-BREAK:break-all; BORDER-BOTTOM:gray 1px solid; BORDER-COLLAPSE:collapse; BACKGROUND-COLOR:#f5fafe; WORD-WRAP:break-word">
							...
							<tr>
								<td style=CURSOR:hand;  align=center  width=15%>
									<a href="javascript:;" onClick="ViewDetail('adjustEdit.jsp?ZhengRi=0&devId=ab15b1290c004d53af24bd2ce8845fa4&seqId=7307')" class="cl_01">
              						UPS123</a>  
								</td>				
								...
								<td style=CURSOR:hand;  align=center  width=8%>
									...
									<a href="javascript:;" onClick="EditDetail('adjustEdit.jsp?ZhengRi=1&devId=ab15b1290c004d53af24bd2ce8845fa4&seqId=7307')" class="cl_01">编辑</a>  
							...
							<tr>
								<td style=CURSOR:hand;  align=center  width=15%>
									<a href="javascript:;" onClick="ViewDetail('adjustEdit.jsp?ZhengRi=0&devId=ab15b1290c004d53af24bd2ce8845fa4&seqId=7310')" class="cl_01">
              						UPS123</a>  
								</td>				
								<td style=CURSOR:hand;  align=center  width=11%>
									2007-06-20
								...
								<td style=CURSOR:hand;  align=center  width=8%>
									...
									<a href="javascript:;" onClick="EditDetail('adjustEdit.jsp?ZhengRi=1&devId=ab15b1290c004d53af24bd2ce8845fa4&seqId=7310')" class="cl_01">编辑</a>  
