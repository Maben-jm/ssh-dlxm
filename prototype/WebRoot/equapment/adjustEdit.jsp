...
<select name="isHaving" id="isHaving" class="bg" style="width:50"   onChange=shareOnChange(this)>
  ...
  <input style="font-size:12px; color:black; height=22;width=55" id="BT_Add" type="button" value="详细" name="BT_Add" onClick="openWindowWithName('adjustFile.jsp?ZhengRi1=1&devId=e11c8381ec0f436b992ba0e44dd33cb0&projId=7313',800,450,'ECC');" />
  </span>
</TD>
</TR>
