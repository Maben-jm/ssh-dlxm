...
function returnConfirm(){
	return confirm("你确定要删除  XXXXX.doc？");
}
</script>
</head>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
		     ...
		     <tr>
		        <td class="ta_01" align="center" bgcolor="#f5fafe" height="22">
		           图纸名称：</td>
		          <td class="ta_01">
		           <input name="fileName" type="text" id="fileName" size="21" onkeydown="returnMethod()">   
		           </td>
		...
		<tr>
			...
			<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1" style="BORDER-RIGHT:gray 1px solid; BORDER-TOP:gray 1px solid; BORDER-LEFT:gray 1px solid; WIDTH:100%; WORD-BREAK:break-all; BORDER-BOTTOM:gray 1px solid; BORDER-COLLAPSE:collapse; BACKGROUND-COLOR:#f5fafe; WORD-WRAP:break-word">
				...
				<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
					...
					<a href="javascript:;" onclick="getUrl('成都台', '电力电压评估报告.doc')">电力电压评估报告.doc</a></td>
					
					<td align="center" style="HEIGHT: 21px">
					<a href="javascript:gotopage('removeInfAndPaper.do?seqId=239','nowpage')" onclick="returnConfirm()">
				...
				<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
					...
					<td align="center"  width="20%">国内图书</td>
					<td align="center"  width="48%">
					<a href="javascript:;" onclick="getUrl('成都台', '国家电网管理系统软件.doc')">国家电网管理系统软件.doc</a></td>
					
					<td align="center" style="HEIGHT: 21px">
					<a href="javascript:gotopage('removeInfAndPaper.do?seqId=238','nowpage')" onclick="returnConfirm()">
					<img src="${pageContext.request.contextPath }/images/delete.gif" width="15" height="14" border="0" style="CURSOR:hand"></a>
					</td>
				...
				<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
					...
					<td align="center" style="HEIGHT: 21px">
					<a href="javascript:gotopage('removeInfAndPaper.do?seqId=237','nowpage')" onclick="returnConfirm()">
					<img src="${pageContext.request.contextPath }/images/delete.gif" width="15" height="14" border="0" style="CURSOR:hand"></a>
					</td>
				...
				<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
					...
					<td align="center" style="HEIGHT: 21px">
					<a href="javascript:gotopage('removeInfAndPaper.do?seqId=236','nowpage')" onclick="returnConfirm()">
					<img src="${pageContext.request.contextPath }/images/delete.gif" width="15" height="14" border="0" style="CURSOR:hand"></a>
					</td>
				...
				<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
					...
					<td align="center" style="HEIGHT: 21px">
					<a href="javascript:gotopage('removeInfAndPaper.do?seqId=235','nowpage')" onclick="returnConfirm()">
					<img src="${pageContext.request.contextPath }/images/delete.gif" width="15" height="14" border="0" style="CURSOR:hand"></a>
					</td>
				...
				<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
					...
					<td align="center" style="HEIGHT: 21px">
					<a href="javascript:gotopage('removeInfAndPaper.do?seqId=234','nowpage')" onclick="returnConfirm()">
					<img src="${pageContext.request.contextPath }/images/delete.gif" width="15" height="14" border="0" style="CURSOR:hand"></a>
					</td>
				...
				<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
					...
					<td align="center" style="HEIGHT: 21px">
					<a href="javascript:gotopage('removeInfAndPaper.do?seqId=226','nowpage')" onclick="returnConfirm()">
					<img src="${pageContext.request.contextPath }/images/delete.gif" width="15" height="14" border="0" style="CURSOR:hand"></a>
					</td>
				...
				<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
					...
					<td align="center" style="HEIGHT: 21px">
					<a href="javascript:gotopage('removeInfAndPaper.do?seqId=225','nowpage')" onclick="returnConfirm()">
					<img src="${pageContext.request.contextPath }/images/delete.gif" width="15" height="14" border="0" style="CURSOR:hand"></a>
					</td>
				...
				<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
					...
					<td align="center" style="HEIGHT: 21px">
					<a href="javascript:gotopage('removeInfAndPaper.do?seqId=224','nowpage')" onclick="returnConfirm()">
					<img src="${pageContext.request.contextPath }/images/delete.gif" width="15" height="14" border="0" style="CURSOR:hand"></a>
					</td>
				...
				<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
					...
					<td align="center" style="HEIGHT: 21px">
					<a href="javascript:gotopage('removeInfAndPaper.do?seqId=223','nowpage')" onclick="returnConfirm()">
					<img src="${pageContext.request.contextPath }/images/delete.gif" width="15" height="14" border="0" style="CURSOR:hand"></a>
					</td>
