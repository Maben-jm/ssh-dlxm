...
<s:form namespace="/system" id="Form1" name="Form1"  method="POST" >
           ...
           <table border="0" width="100%" cellspacing="0" cellpadding="0">
               <tr>
                   <td width="30%" rowspan="4">
                       ...
                       <s:select list="#request.noMap" name="colname1" id="colname1" size="15" cssStyle="width:200px" multiple="true" ondblclick="JavaScript:Add('colname1','colname2','colname')">
                       </s:select>

                   </td>
                   <td width="15%"></td>
                   <td width="35%" rowspan="4" id="colnameDiv">
                        <s:select list="#request.map" name="colname2" id="colname2" size="15"  multiple="true"  cssStyle="width:200px" ondblclick="JavaScript:Remove('colname1','colname2','colname')"></s:select>
                   </td>
