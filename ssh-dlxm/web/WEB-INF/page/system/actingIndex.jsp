...
<body>
<div id="opperate">
	<s:form namespace="/system" name="Form1" id="Form1" method="post">
		<s:hidden name="comID" value="%{comID}"></s:hidden>
					...
					<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
						...
						<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
							<td style="HEIGHT:22px" align="center" width="40%">
								<s:property value="%{stationRun}"></s:property>
							</td>
							<td style="HEIGHT:22px" align="center" width="40%">
								<s:property value="%{devRun}"></s:property>
							</td>
							<td style="HEIGHT:22px" align="center" width="20%">
									<%--<s:property value="%{createDate}"></s:property><br/>--%>
									<%--${createDate}<br/>--%>
								<s:date name="createDate" format="yyyy-MM-dd HH:mm:ss"></s:date>
							</td>
						</tr>
					</table>
				</td>
