				...
				<tr style="FONT-WEIGHT:bold;FONT-SIZE:12pt;HEIGHT:25px;BACKGROUND-COLOR:#afd1f3">
		   		...
		   		<s:if test="#request.list!=null && #request.list.size()>0">
					<s:iterator value="#request.list" var="item">
						<tr>
							<td class="ta_01" align="center"  width="20%"><s:property value="%{#item.ddlCode}"></s:property></td>
							<td class="ta_01" align="center"  width="60%">
								<input id="itemname" name="itemname" type="text" value="<s:property value="%{#item.ddlName}"></s:property>"  size="45" maxlength="25"></td>
							<td class="ta_01" align="center"  width="20%">
								<a href="#" onclick="delTableRow('<s:property value="%{#item.ddlCode}"></s:property>')">
