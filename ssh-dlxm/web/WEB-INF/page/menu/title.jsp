...
<table border="0" width="100%" height="9" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="100%" height="1" bgcolor="#66C89C" colspan="4"><img border="0" src="${pageContext.request.contextPath }
    /images/titleline.jpg" width="100%" height="3"></td>
  </tr>
  <tr>
    ...
    <b><font color="#FFFFFF">欢迎您!&nbsp;&nbsp;&nbsp;${session.globle_user.userName}</font></b>
    </td></tr></table>
    </td>
