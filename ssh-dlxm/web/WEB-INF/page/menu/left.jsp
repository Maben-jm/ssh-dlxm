...
//		a=bb;
					...
					<TD vAlign="top" bgColor="#F6F6F6" height="100%">
						...
						<DIV class="parent" id="KB0Parent">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TBODY>
									<TR height=25 >
										<TD align="left" background="${pageContext.request.contextPath }
    /images/b-info.gif"  vAlign="middle">
    ...
    /WEB-INF/page/system/userIndex.jsp" target="mainFrame">用户管理</A>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }
    /WEB-INF/page/system/roleIndex.jsp" target="mainFrame">角色管理</A>
										</TD>
									</TR>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }
    /WEB-INF/page/system/dictionaryIndex.jsp" target="mainFrame">数据字典维护</A>
										</TD>
									</TR>
							...
							<TABLE cellSpacing="0" cellPadding="0" width="99%" border="0">
								<TBODY>
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }
    /WEB-INF/page/workflow/processDefinitionList.jsp" target="mainFrame">审批流程管理</A>
										</TD>
									</TR>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }
    /WEB-INF/page/workflow/applicationTemplateList.jsp" target="mainFrame">申请模板管理</A>
										</TD>
									</TR>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }
    /WEB-INF/page/workflow/flowTemplateList.jsp" target="mainFrame">起草申请</A>
										</TD>
									</TR>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }
    /WEB-INF/page/workflow/flowMyTaskList.jsp" target="mainFrame">待我审批</A>
										</TD>
									</TR>
									...
									<TR>
										<TD class="box06" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }
    /WEB-INF/page/workflow/flowMyApplicationList.jsp" target="mainFrame">我的申请查询</A>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
