	...
	<table width="100%" border="0" height="88" border="1" background=${pageContext.request.contextPath }/images/back1.jpg>
		...
		<tr>
			<td width="50%" height="84" align="left" valign="top" id="stationtd">
			    ...
			    <fieldset id="stationset" style="width: 500px; height: 430px; padding: 1px; background:"${pageContext.request.contextPath }/images/back1.JPG"><legend>
				    <font color="#0000FF">
					...
					<IFRAME src="${pageContext.request.contextPath }/system/elecMenuAction_alermStation.do"  name="station" id="station" frameBorder="0" width="500" scrolling="auto" height="400"></IFRAME>
			...
			<td width="50%" align="left" valign="top" id="devtd">
				<fieldset id="devset" style="width: 500px; height: 430px; padding: 1px ;background:"${pageContext.request.contextPath }/images/back1.JPG"><legend>
					<font color="#0000FF">
					<img border="0" src="${pageContext.request.contextPath }/images/zoom.gif" width="14" height="14"><a href="#" onclick="shiftiframe('2')">设备运行情况</a></font></legend>
	             	<IFRAME src="${pageContext.request.contextPath }/system/elecMenuAction_alermDevice.do"  name="dev" id="dev" frameBorder="0" width="500" scrolling="auto" height="400"></IFRAME>
				</fieldset>
			</td>
		</tr>
