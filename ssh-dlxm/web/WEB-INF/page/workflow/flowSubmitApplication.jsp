...
<html>
    ...
    <body>
        <s:form name="Form1" namespace="workflow" action="elecApplicationFlowAction_saveApplication.do" method="post" enctype="multipart/form-data">
            ...
            <table border="0" width="90%" cellspacing="1" cellpadding="0" align="center" bgcolor="#f5fafe">
                ...
                <tr>
                    ...
                    <td class="ta_01" bgColor="#ffffff" colspan="3">
                        ...
                        <a id="saveElecApplication" href="${pageContext.request.contextPath }/workflow/elecApplicationTemplateAction_download.do?id=<s:property value="%{applicationTemplateID }" />"
                           style="text-decoration: underline">[点击下载申请模板文件]</a>
                    </td>
                </tr>
                <tr height=10>
                    <td colspan=4></td>
                ...
                <tr>
                    ...
                    <td class="ta_01" bgColor="#ffffff" colspan="3">
                        <s:file name="upload" class="InputStyle" cssStyle="width:450px;"></s:file>
                    </td>
                </tr>
                <tr height=10>
                    <td colspan=4></td>
