                    ...
                    <tr>
                        <td class="ta_01" align="left" bgColor="#f5fafe" colspan="2">
                            ...
                            <s:if test="#request.templateList!=null && #request.templateList.size()>0">
                                <s:iterator value="#request.templateList" var="item">
                                    <img width="16" height="16" src="${pageContext.request.contextPath }/images/doc.gif"/>
                                    <s:property value="%{#item.id}"/>
                                    <a href="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_submitApplication.do?applicationTemplateID=<s:property value="%{#item.id}"/>">
