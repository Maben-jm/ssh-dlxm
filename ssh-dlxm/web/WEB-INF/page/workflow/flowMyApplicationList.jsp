...
<html>
    ...
    <body>
        ...
        <s:form id="Form1" namespace="workflow" name="Form1" action="elecApplicationFlowAction_myApplicationHome.do" method="post" cssStyle="margin:0px;">
            <table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
                ...
                <tr>
                    ...
                    <td class="ta_01">
                        <s:select list="#request.templateList"
                                  headerKey="" headerValue="查看全部模板"
                                  listKey="id" listValue="name"
                                  name="applicationTemplateID" id="applicationTemplateID" cssStyle="width:155px"
                        >
                        </s:select>
                    </td>
                    <td class="ta_01" align="center" bgcolor="#f5fafe" height="22">
                    ...
                    <tr>
                        <td>
                            <TABLE style="WIDTH: 105px; HEIGHT: 20px" border="0">
                                <TR>
                                    <TD align="center" background="${pageContext.request.contextPath }/images/cotNavGround.gif"><img src="${pageContext.request.contextPath }/images/yin.gif"
                                                                                                                                     width="15"></TD>
                        ...
                        <td class="ta_01" align="right">
                            <input style="font-size:12px; color:black; height:20px;width:80px" id="BT_Flush" type="button" value="查询" name="BT_Flush"
                                    ...
                                    <s:iterator value="#request.applicationList" var="application">
                                        <tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
                                            ...
                                            <td style="HEIGHT:22px" align="center" width="12%">
                                                <a id="Form2_"
                                                   href="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_approvedHistory.do?applicationID=${application.applicationID }"><img
                                                src="${pageContext.request.contextPath }/images/button_view.gif" border="0" style="CURSOR:hand"></a>
                                            </td>
                                        </tr>
                                    </s:iterator>
                                </s:if>
