...
<html>
    <head>
        ...
        <script type="text/javascript">
            function returnMethod(name, key, id) {
                ...
                if (flag) {
                    document.getElementById(id).href = "elecProcessDefinitionAction_delete.do?key=" + key;
                    return true;
                } else {
                    return false;
                }
    ...
    <body>
        ...
        <s:form namespace="/workflow" id="Form1" name="Form1" action="elecProcessDefinitionAction_home.do" method="post" cssStyle="margin:0px;">
                    ...
                    <tr>
                        <td class="ta_01" align="center" bgColor="#f5fafe" colspan="2">
                            <table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
                                ...
                                <s:if test="#request.processDefinitions!=null && #request.processDefinitions.size()>0">

                                    <s:iterator value="#request.processDefinitions" var="item">
                                        <tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
                                            <td style="HEIGHT:22px" align="center" width="30%">
                                                <s:property value="%{#item.name}"></s:property>
                                            </td>
                                            <td style="HEIGHT:22px" align="center" width="30%">
                                                <s:property value="%{#item.version}"></s:property>
                                            </td>
                                            ...
                                            <td style="HEIGHT:22px" align="center" width="10%">
                                                <a href="#" onclick="openFunction('<s:property value="%{#item.id}"/>')">
